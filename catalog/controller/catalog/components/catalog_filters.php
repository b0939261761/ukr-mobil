<?
class ControllerCatalogComponentsCatalogFilters extends Controller {
  public function index() {
    $data['available'] = $this->request->get['available'] ?? null;
    $data['filters'] = $this->getFilters();
    return $this->load->view('catalog/components/catalog_filters/catalog_filters', $data);
  }
  ...
  private function getFilters() {
    ...
    foreach ($filters as &$item) {
      ...
      foreach ($values as &$value) {
        ...
        $requestFilters = $this->catalog->getFilters();
