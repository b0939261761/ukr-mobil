...
class ControllerStartupSession extends Controller {
	public function index() {
      ...
      // setcookie($this->config->get('session_name'), $this->session->getId(), timeini_get('session.cookie_lifetime'), ini_get('session.cookie_path'), ini_get('session.cookie_domain'));
