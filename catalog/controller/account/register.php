...
class ControllerAccountRegister extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			//region Update User
			$customerRow = $customerModel->get($customer_id, true);

			if (!empty($customerRow)) {
				$customerRow
					->setRegion($this->request->post['ego-form-field-region'])
					->setCity($this->request->post['ego-form-field-city'])
					->setWarehouse($this->request->post['ego-form-field-warehouse']);
