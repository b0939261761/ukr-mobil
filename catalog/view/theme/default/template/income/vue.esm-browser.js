...
* @private
*/
const toDisplayString = val => (val == null
  ? ''
  : isObject(val)
...
let _globalThis;
const getGlobalThis = () => (_globalThis
...
function renderComponentRoot(instance) {
  const {
    type: Component, vnode, proxy, withProxy, props, propsOptions: [propsOptions], slots, attrs, emit, render, renderCache, data, setupState, ctx
  } = instance;
  let result;
...
const isElementRoot = vnode => (vnode.shapeFlag & 6
      || /* COMPONENT */ vnode.shapeFlag & 1
      || /* ELEMENT */ vnode.type === Comment // potential v-if branch switch
);
...
function patchSuspense(n1, n2, container, anchor, parentComponent, isSVG, slotScopeIds, optimized, { p: patch, um: unmount, o: { createElement } }) {
  ...
  const {
    activeBranch, pendingBranch, isInFallback, isHydrating
  } = suspense;
  if (pendingBranch) {
...
function createSuspenseBoundary(vnode, parent, parentComponent, container, hiddenContainer, anchor, isSVG, slotScopeIds, optimized, rendererInternals, isHydrating = false) {
  ...
  const {
    p: patch, m: move, um: unmount, n: next, o: { parentNode, remove }
  } = rendererInternals;
  ...
  const suspense = {
    ...
    resolve(resume = false) {
      ...
      const {
        vnode, activeBranch, pendingBranch, pendingId, effects, parentComponent, container
      } = suspense;
    ...
    fallback(fallbackVNode) {
      ...
      const {
        vnode, activeBranch, parentComponent, container, isSVG
      } = suspense;
...
function resolveTransitionHooks(vnode, props, state, instance) {
  const {
    appear, mode, persisted = false, onBeforeEnter, onEnter, onAfterEnter, onEnterCancelled, onBeforeLeave, onLeave, onAfterLeave, onLeaveCancelled, onBeforeAppear, onAppear, onAfterAppear, onAppearCancelled
  } = props;
...
function createHydrationFunctions(rendererInternals) {
    ...
    switch (type) {
      ...
      default:
        if (shapeFlag & 1 /* ELEMENT */) {
          if (domType !== 1
                      || /* ELEMENT */ vnode.type.toLowerCase()
  ...
  const hydrateElement = (el, vnode, parentComponent, parentSuspense, slotScopeIds, optimized) => {
    ...
    const {
      props, patchFlag, shapeFlag, dirs
    } = vnode;
    ...
    if (patchFlag !== -1 /* HOISTED */) {
      ...
      if (props) {
        if (!optimized
                  || (patchFlag & 16
                      || /* FULL_PROPS */ patchFlag & 32 /* HYDRATE_EVENTS */)) {
...
function baseCreateRenderer(options, createHydrationFns) {
  ...
  const mountElement = (vnode, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) => {
    ...
    let vnodeHook;
    const {
      type, props, shapeFlag, transition, patchFlag, dirs
    } = vnode;
    {
    ...
    for (let i = 0; i < newChildren.length; i++) {
      ...
      const container =
          ...
          oldVNode.type === Fragment
              ...
              || /* COMPONENT */ oldVNode.shapeFlag & 64 /* TELEPORT */
  ...
  const processFragment = (n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized) => {
    ...
    if (n1 == null) {
      ...
      mountChildren(n2.children, container, fragmentEndAnchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized);
              ...
              && patchFlag & 64
              && /* STABLE_FRAGMENT */ dynamicChildren
  ...
  const patchChildren = (n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized = false) => {
    ...
    if (patchFlag > 0) {
      ...
      if (patchFlag & 256 /* UNKEYED_FRAGMENT */) {
        // unkeyed
  ...
  const move = (vnode, container, anchor, moveType, parentSuspense = null) => {
    const {
      el, type, transition, children, shapeFlag
    } = vnode;
    ...
    if (shapeFlag & 6 /* COMPONENT */) {
      ...
      if (shapeFlag & 64 /* TELEPORT */) {
        ...
        unmountChildren(dynamicChildren, parentComponent, parentSuspense, false, true);
              ...
              && (patchFlag & 128
                  || /* KEYED_FRAGMENT */ patchFlag & 256 /* UNKEYED_FRAGMENT */))
...
const TeleportImpl = {
  ...
  process(n1, n2, container, anchor, parentComponent, parentSuspense, isSVG, slotScopeIds, optimized, internals) {
    const {
      mc: mountChildren, pc: patchChildren, pbc: patchBlockChildren, o: {
        insert, querySelector, createText, createComment
      }
    } = internals;
  ...
  remove(vnode, parentComponent, parentSuspense, optimized, { um: unmount, o: { remove: hostRemove } }, doRemove) {
    const {
      shapeFlag, children, anchor, targetAnchor, target, props
    } = vnode;
    if (target) {
...
function moveTeleport(vnode, container, parentAnchor, { o: { insert }, m: move }, moveType = 2 /* REORDER */) {
  ...
  const {
    el, anchor, shapeFlag, children, props
  } = vnode;
...
function isSameVNodeType(n1, n2) {
  if (n2.shapeFlag & 6
      && /* COMPONENT */ hmrDirtyComponents.has(n2.type)) {
...
const createVNodeWithArgsTransform = (...args) => _createVNode(...(vnodeArgsTransformer
  ...
  if (asMixin) {
    if (components) {
      extend(instance.components
              || (instance.components = { ...instance.type.components }), components);
    }
    if (directives) {
      extend(instance.directives
              || (instance.directives = { ...instance.type.directives }), directives);
    }
  }
  // lifecycle options
  if (!asMixin) {
...
const PublicInstanceProxyHandlers = {
  get({ _: instance }, key) {
    const {
      ctx, setupState, data, props, accessCache, type, appContext
    } = instance;
  ...
  has({
    _: {
      data, setupState, accessCache, ctx, appContext, propsOptions
    }
  }, key) {
    let normalizedProps;
...
function formatComponentName(instance, Component, isRoot = false) {
  ...
  if (!name && instance && instance.parent) {
    ...
    name = inferFromRegistry(instance.components
...
const TransitionPropsValidators = (Transition.props = /* #__PURE__ */ { ...BaseTransition.props, ...DOMTransitionPropsValidators });
function resolveTransitionProps(rawProps) {
  ...
  const {
    onBeforeEnter, onEnter, onEnterCancelled, onLeave, onLeaveCancelled, onBeforeAppear = onBeforeEnter, onAppear = onEnter, onAppearCancelled = onEnterCancelled
  } = baseProps;
...
const rendererOptions = { patchProp, forcePatchProp, ...nodeOps };
...
function isText(node) {
  return node.type === 5 /* INTERPOLATION */ || node.type === 2;
}
function isVSlot(p) {
...
function isSlotOutlet(node) {
  return node.type === 1 /* ELEMENT */ && node.tagType === 2;
}
  ...
  if (props == null || isString(props)) {
    ...
    if (prop.key.type === 4 /* SIMPLE_EXPRESSION */) {
      ...
      alreadyExists = props.properties.some(p => p.key.type === 4
              && /* SIMPLE_EXPRESSION */ p.key.content === propKeyName);
    }
    if (!alreadyExists) {
...
function pushNode(nodes, node) {
  if (node.type === 2 /* TEXT */) {
    ...
    if (prev
          && prev.type === 2
          && /* TEXT */ prev.loc.end.offset === node.loc.start.offset) {
...
function walk(node, context, doNotHoistNode = false) {
  ...
  for (let i = 0; i < children.length; i++) {
    ...
    if (child.type === 1
          && /* ELEMENT */ child.tagType === 0 /* ELEMENT */) {
...
function createCodegenContext(ast, {
  mode = 'function', prefixIdentifiers = mode === 'module', sourceMap = false, filename = 'template.vue.html', scopeId = null, optimizeImports = false, runtimeGlobalName = 'Vue', runtimeModuleName = 'vue', ssr = false
}) {
  const context = {
    mode,
    prefixIdentifiers,
...
function generate(ast, options = {}) {
  ...
  const {
    mode, push, prefixIdentifiers, indent, deindent, newline, scopeId, ssr
  } = context;
...
function genFunctionPreamble(ast, context) {
  const {
    ssr, prefixIdentifiers, push, newline, runtimeModuleName, runtimeGlobalName
  } = context;
...
function isText$1(n) {
  return (isString(n)
      || n.type === 4
      || /* SIMPLE_EXPRESSION */ n.type === 2
      || /* TEXT */ n.type === 5
      || /* INTERPOLATION */ n.type === 8 /* COMPOUND_EXPRESSION */);
}
...
function genVNodeCall(node, context) {
  const { push, helper, pure } = context;
  const {
    tag, props, children, patchFlag, dynamicProps, directives, isBlock, disableTracking
  } = node;
  if (directives) {
...
function genFunctionExpression(node, context) {
  const {
    push, indent, deindent, scopeId, mode
  } = context;
  const {
    params, returns, body, newline, isSlot
  } = node;
  if (isSlot) {
  ...
  if (node.type === 5 /* INTERPOLATION */) {
    ...
    for (let i = 0; i < node.props.length; i++) {
      ...
      if (dir.type === 7 /* DIRECTIVE */ && dir.name !== 'for') {
        ...
        if (exp
                  && exp.type === 4
                  && /* SIMPLE_EXPRESSION */ !(dir.name === 'on' && arg)) {
...
function processIf(node, dir, context, processCodegen) {
  ...
  if (dir.name === 'if') {
    ...
    while (i-- >= -1) {
      ...
      if (sibling
              && sibling.type === 2
              && /* TEXT */ !sibling.content.trim().length) {
        context.removeNode(sibling);
        continue;
      }
      if (sibling && sibling.type === 9 /* IF */) {
...
function isSameKey(a, b) {
  ...
  if (a.type === 6 /* ATTRIBUTE */) {
    ...
    if (exp.type !== 4
          || /* SIMPLE_EXPRESSION */ (exp.isStatic !== branchExp.isStatic
...
const transformFor = createStructuralDirectiveTransform('for', (node, dir, context) => {
  ...
  return processFor(node, dir, context, forNode => {
    ...
    const isStableFragment = forNode.source.type === 4
          && /* SIMPLE_EXPRESSION */ forNode.source.constType > 0;
...
const trackSlotScopes = (node, context) => {
  if (node.type === 1
      && /* ELEMENT */ (node.tagType === 1
          || /* COMPONENT */ node.tagType === 3 /* TEMPLATE */)) {
...
function hasForwardedSlots(children) {
  for (let i = 0; i < children.length; i++) {
    ...
    switch (child.type) {
      case 1 /* ELEMENT */:
        if (child.tagType === 2
                  || /* SLOT */ (child.tagType === 0
                      && /* ELEMENT */ hasForwardedSlots(child.children))) {
          return true;
        }
        break;
      case 9 /* IF */:
...
const transformElement = (node, context) =>
  ...
  function postTransformElement() {
    node = context.currentNode;
    if (!(node.type === 1
          && /* ELEMENT */ (node.tagType === 0
              || /* ELEMENT */ node.tagType === 1 /* COMPONENT */))) {
      return;
    }
...
function buildProps(node, context, props = node.props, ssr = false) {
  ...
  const analyzePatchFlag = ({ key, value }) => {
    if (isStaticExp(key)) {
      ...
      if (value.type === 20
              || /* JS_CACHE_EXPRESSION */ ((value.type === 4
                  || /* SIMPLE_EXPRESSION */ value.type === 8 /* COMPOUND_EXPRESSION */)
...
function processSlotOutlet(node, context) {
  ...
  for (let i = 0; i < node.props.length; i++) {
    ...
    } else if (p.name === 'bind' && isBindKey(p.arg, 'name')) {
...
const transformText = (node, context) => {
  if (node.type === 0
      || /* ROOT */ node.type === 1
      || /* ELEMENT */ node.type === 11
      || /* FOR */ node.type === 10 /* IF_BRANCH */) {
    ...
    return () => {
      ...
      if (!hasText
              ...
              || (children.length === 1
                  && (node.type === 0
                      || /* ROOT */ (node.type === 1
                          && /* ELEMENT */ node.tagType === 0 /* ELEMENT */)))) {
        return;
      }
...
function baseCompile(template, options = {}) {
  ...
  transform(ast, {
    ...
    directiveTransforms: { ...directiveTransforms, ...options.directiveTransforms || {} // user transforms
    }
  });
...
const parserOptions = {
  ...
  isBuiltInComponent: tag => {
    if (isBuiltInType(tag, 'Transition')) {
      return TRANSITION$1;
    } if (isBuiltInType(tag, 'TransitionGroup')) {
...
const transformModel$1 = (dir, node, context) => {
  ...
  baseResult.props = baseResult.props.filter(p => !(p.key.type === 4
      && /* SIMPLE_EXPRESSION */ p.key.content === 'modelValue'));
  return baseResult;
};
...
const transformOn$1 = (dir, node, context) => transformOn(dir, node, context, baseResult => {
  const { modifiers } = dir;
...
function hasMultipleChildren(node) {
  ...
  return (children.length !== 1
      || child.type === 11
      || /* FOR */ (child.type === 9 /* IF */ && child.branches.some(hasMultipleChildren)));
}

const ignoreSideEffectTags = (node, context) => {
  if (node.type === 1
      && /* ELEMENT */ node.tagType === 0
      && /* ELEMENT */ (node.tag === 'script' || node.tag === 'style')) {
...
function compile$1(template, options = {}) {
  return baseCompile(template, {
    ...
    directiveTransforms: { ...DOMDirectiveTransforms, ...options.directiveTransforms || {} },
    transformHoist: null
  });
}
