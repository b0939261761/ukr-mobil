...
// public function sendMail($to, $subject, $viewName, $data = []) {
//   $from['robot@ukr-mobil.com'] = 'UKR Mobil';
...
//   $blade = new \Philo\Blade\Blade(DIR_APPLICATION . 'view/theme/default/mails', DIR_CACHE);
