    ...
    >
        <tbody>
            ...
            <tr>
                <td colspan="2" style="width: 50%;">
                    <p style="text-align: center;">
                        <?php echo e($data['recipient']['deliveryPlace']); ?>
    ...
    >
        ...
        <tbody>
            <?php $__currentLoopData = $data['productList']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        <?php echo e($data['currency']->format($item['price'], $data['session']->data['currency'])); ?>
                    ...
                    <td style="text-align: center;">
                        ...
                        <?php echo e($data['currency']->format($item['total'], $data['session']->data['currency'])); ?>
            ...
            <tr>
                ...
                >
                    <b>Итого:</b>
                    <?php echo e($data['currency']->format($data['total'], $data['session']->data['currency'])); ?>
...
<?php /**PATH /home/admin/web/ukr-mob.reality.sh/public_html/ego/views/mails/new-order.blade.php ENDPATH**/ ?>